...
describe("TenseHubMap component", () => {
  ...
  it("renders tense groups with a maximum of 3 columns on desktop and no 4/5/6 column classes", () => {
    ...
    // Verify lg:grid-cols-4, xl:grid-cols-5 and 2xl:grid-cols-6 are NOT present
    expect(gridContainer?.className).not.toContain("lg:grid-cols-4");
