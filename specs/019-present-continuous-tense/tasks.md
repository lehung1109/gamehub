...
- [x] T001 Ask the user to confirm the creation of a new git worktree for workspace isolation, defaulting to creating a new one. (e.g., `git worktree add ../gamehub-019-present-continuous-tense 019-present-continuous-tense`)
- [x] T002 Spawn a dedicated subagent to execute the Phase 1 Iterative Review & Bug Hunt (verify spec compliance, zero bugs).
