      ...
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl p-8 max-w-md w-full text-center space-y-4 shadow-2xl">
          ...
          <h2 className="text-xl font-bold text-slate-900">
            Không tìm thấy phòng đấu hoặc mã PIN không hợp lệ
          </h2>
          ...
          <Link
            href="/arena"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-base transition-colors"
          >
            <ArrowLeft className="size-5" />
            <span>Nhập mã PIN khác</span>
          </Link>
        </div>
      </div>
    )
